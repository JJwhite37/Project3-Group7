function LandingPage() {
    return (
      <div>
        ...
        <p>
          Once logged in, we display all the information from a flexpool api in an easy to understand Dashboard.  
        </p>
        <p>
        ...
        <p>
        Since, EcomMiner is a open source platform that makes it easy for communities or creators to get paid. 
        Ecom miner is a great way to internationally source computation(mining Ethereum) for services from creators. 
        Instead of literally throwing money at your screen (trust us, that doesn’t work), you can run you hardware(GPU) per month to pay for individual service's from simple company's raffle's, or even greater privileges like subscriptions.
        </p>
